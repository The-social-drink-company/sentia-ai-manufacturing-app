                      ...
                      <div key={log.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-500">{log.user} â€¢ {formatDateTime(log.timestamp)}</p>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            {log.user} â€¢ {formatDateTime(log.timestamp)}
                          </p>
                          <p className="text-xs text-gray-400">
                            Resource: {log.resource} â€¢ IP: {log.ip_address}
                          </p>
                        </div>
                      </div>
                      <span className={`inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium border ${
