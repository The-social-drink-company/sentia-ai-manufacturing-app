  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        setDashboardData({
          kpis: [
            { id: 'revenue', title: 'Total Revenue', value: '£2.8M', change: '+15.9%', changeType: 'increase', icon: 'currency', description: 'Monthly recurring revenue' },
            ...
            { id: 'inventory', title: 'Inventory Value', value: '£1.8M', change: '-3.9%', changeType: 'decrease', icon: 'package', description: 'Current stock valuation' },
