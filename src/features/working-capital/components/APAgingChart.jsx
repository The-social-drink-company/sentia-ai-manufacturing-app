...
export default function APAgingChart({ data }) {
  if (!data) {
    return (
      <div className="h-64 flex items-center justify-center">
        <p className="text-gray-500">No payables data available</p>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4 pt-4 border-t">
        ...
        <div>
          <p className="text-sm text-gray-500">Overdue (60+ Days)</p>
      ...
      {data.topSuppliers && data.topSuppliers.length > 0 && (
        <div className="pt-4 border-t">
          ...
          <div className="space-y-2">
            {data.topSuppliers.slice(0, 3).map((supplier, _index) => (
              <div key={index} className="flex justify-between items-center text-sm">
                ...
                <div className="text-right">
                  ...
                  <span className="text-gray-500 ml-2">({supplier.daysOutstanding} days)</span>
                </div>
              </div>
            ))}
          </div>
