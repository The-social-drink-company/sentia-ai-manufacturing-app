    ...
    try {
      ...
      if (optimization.unlock90Days > 50000) {
        talkingPoints.push({
          ...
          message: `Potential to unlock Â£${(optimization.unlock90Days / 1000).toFixed(0)}K in working capital within 90 days`,
      ...
      if (optimization.unlock365Days > 200000) {
        talkingPoints.push({
          ...
          message: `12-month cash flow improvement of Â£${(optimization.unlock365Days / 1000).toFixed(0)}K without new debt`,
      ...
      if (growthFunding.totalGrowthFunding > 0) {
        talkingPoints.push({
          ...
          message: `Â£${(growthFunding.totalGrowthFunding / 1000).toFixed(0)}K funding needed to support ${expectedGrowthRate}% growth target`,
