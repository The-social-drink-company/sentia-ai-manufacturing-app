...
export class CashConversionCycleEngine {
  constructor(options = {}) {
    ...
    this.config = {
      ...
      targetDPO: options.targetDPO || 60,  // Days Payable Outstanding  
      targetDIO: options.targetDIO || 30,  // Days Inventory Outstanding
  ...
  calculateCashConversionCycle(baseMetrics = {}) {
    ...
    const metrics = {
      annualRevenue: baseMetrics.annualRevenue || 40000000,
      annualCOGS: baseMetrics.annualCOGS || 26000000,
