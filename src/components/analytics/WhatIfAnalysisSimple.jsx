...
const WhatIfAnalysisSimple = () => {
  ...
  const calculateImpact = () => {
    const baseRevenue = 2800000; // £2.8M base
    const baseCost = 1960000; // £1.96M base (70% of revenue)
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-sm mt-1 ${impact.revenue > 2800000 ? 'text-green-600' : 'text-red-600'}`}>
                  {impact.revenue > 2800000 ? '↑' : '↓'} {formatPercent(((impact.revenue - 2800000) / 2800000) * 100)}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-sm mt-1 ${impact.profit > 840000 ? 'text-green-600' : 'text-red-600'}`}>
                  {impact.profit > 840000 ? '↑' : '↓'} {formatPercent(((impact.profit - 840000) / 840000) * 100)}
                </p>
              </div>
