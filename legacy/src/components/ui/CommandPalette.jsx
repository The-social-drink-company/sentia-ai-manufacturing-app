            ...
            >
              ...
              <div className="px-4 py-2 border-t border-gray-200 dark:border-quantum-border
                ...
                <div className="flex items-center gap-4">
                  <span className="flex items-center gap-1">
                    <kbd className="px-1 py-0.5 bg-gray-100 dark:bg-quantum-twilight rounded">â†‘â†“</kbd>
                    <span>Navigate</span>
                  </span>
                  <span className="flex items-center gap-1">
                    <kbd className="px-1 py-0.5 bg-gray-100 dark:bg-quantum-twilight rounded">â†µ</kbd>
                    <span>Select</span>
                  </span>
                  <span className="flex items-center gap-1">
