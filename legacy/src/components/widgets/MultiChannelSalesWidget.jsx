  ...
  return (
    <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 ${className}`}>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Last {timeRange} â€¢ {processedData?.totals.activeChannels || 0} channels active
              </p>
            </div>
          </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500 dark:text-gray-400">
                        {channel.orders} orders â€¢ {formatCurrency(channel.revenue)}
                      </div>
                    </div>
                  </div>
      ...
      <div className="px-4 py-3 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-600 text-xs text-gray-500 dark:text-gray-400">
        <div className="flex items-center justify-between">
          <span>
            Last updated: {processedData ? new Date(processedData.timestamp).toLocaleTimeString() : 'â€”'}
          </span>
