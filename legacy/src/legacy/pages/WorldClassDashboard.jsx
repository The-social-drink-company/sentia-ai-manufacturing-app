          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li>â€¢ Production efficiency expected to increase 8% next week</li>
                <li>â€¢ Quality metrics trending upward with 94% confidence</li>
                <li>â€¢ Inventory optimization saving $45K monthly</li>
              </ul>
            </div>
          </div>
        </EnterpriseWidget>
