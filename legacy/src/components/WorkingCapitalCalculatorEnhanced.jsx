...
2024-06-01,208333,330000,220000,140000,135000`
  ...
  const boardTalkingPoints = [
    `Potential to unlock Â£${results.cashUnlock90Days.toLocaleString()} in working capital within 90 days`,
    `12-month cash flow improvement of Â£${results.cashImprovement12Months.toLocaleString()} without new debt`,
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="currentCash">Current Cash on Hand (Â£)</Label>
                      <Input
                        id="currentCash"
                        type="number"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="currentDebtors">Current Debtors (Â£)</Label>
                      <Input
                        id="currentDebtors"
                        type="number"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="currentCreditors">Current Creditors (Â£)</Label>
                      <Input
                        id="currentCreditors"
                        type="number"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="ebitda">EBITDA (Â£)</Label>
                      <Input
                        id="ebitda"
                        type="number"
                ...
                <CardContent>
                  <div className="text-center space-y-4">
                    <div className="text-4xl font-bold text-green-600">
                      Â£{results.cashUnlock90Days.toLocaleString()}
                    </div>
                    ...
                    <div className="text-2xl font-bold text-slate-900 dark:text-white">
                      Â£{results.cashImprovement12Months.toLocaleString()}
                    </div>
                    <p className="text-sm text-slate-600 dark:text-slate-400">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700 dark:text-blue-300">
                        ...
                        Â£{Math.round(results.cashUnlock90Days * 0.6).toLocaleString()} in 60 days.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-purple-700 dark:text-purple-300">
                        ...
                        Â£{Math.round((formData.annualRevenue * formData.revenueGrowth / 100) * 0.15).toLocaleString()} 
