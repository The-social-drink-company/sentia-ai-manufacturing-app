          ...
          <div style={{
            ...
            <div style={{
              ...
              <ul style={{ 
                ...
                <li style={{ marginBottom: '0.25rem' }}>✓ Real-time production pipeline tracking</li>
                <li style={{ marginBottom: '0.25rem' }}>✓ Multi-channel sales analytics (Amazon, Shopify)</li>
                <li style={{ marginBottom: '0.25rem' }}>✓ AI-powered demand forecasting</li>
                <li style={{ marginBottom: '0.25rem' }}>✓ Unleashed ERP & Xero integration</li>
                <li>✓ MCP vector database insights</li>
              </ul>
            </div>
          </div>
        </div>
