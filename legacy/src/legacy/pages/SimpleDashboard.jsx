        ...
        <div className="mt-8 bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <p className="text-3xl font-bold text-blue-600">Â£1.2M</p>
              <p className="text-gray-600">Cash Flow</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-green-600">Â£890K</p>
              <p className="text-gray-600">Accounts Receivable</p>
            </div>
            <div className="text-center">
              <p className="text-3xl font-bold text-orange-600">Â£450K</p>
