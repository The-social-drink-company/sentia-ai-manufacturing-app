        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <ul className="text-sm text-amber-700 space-y-1">
              <li>â€¢ Regularly review and end unused sessions</li>
              <li>â€¢ Use unique, strong passwords</li>
              <li>â€¢ Be cautious when accessing your account from public networks</li>
              <li>â€¢ Report any suspicious account activity immediately</li>
              {securityStatus?.failedLoginCount > 0 && (
                <li className="font-medium">â€¢ Recent failed login attempts detected - review your account security</li>
              )}
            </ul>
          </div>
        </div>
