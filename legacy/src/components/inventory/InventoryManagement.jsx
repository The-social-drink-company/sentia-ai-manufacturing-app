        ...
        <div className="mb-6 bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
          ...
          <div className="mt-2 space-y-1">
            {lowStockItems.slice(0, 3).map((item, index) => (
              <p key={index} className="text-sm text-orange-700 dark:text-orange-300">â€¢ {item.name}: {item.currentStock} units remaining</p>
            ))}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600 mt-2">Â£{inventoryData?.kpis?.totalValue || 0}</p>
