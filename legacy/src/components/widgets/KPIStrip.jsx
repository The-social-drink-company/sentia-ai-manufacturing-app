  ...
  const kpiCards = [
    {
      key: 'revenue',
      title: 'Revenue (24h)',
      value: kpiData?.totalRevenue.value ? `Â£${(kpiData.totalRevenue.value / 1000).toFixed(0)}K` : 'â€”',
    ...
    },
    {
      key: 'stock',
      title: 'Stock Level',
      value: kpiData?.stockLevel.value?.toFixed(1) || 'â€”',
      suffix: '%',
    ...
    },
    {
      ...
      value: kpiData?.forecastAccuracy.value?.toFixed(1) || 'â€”',
      suffix: '%',
    ...
    },
    {
      ...
      value: kpiData?.capacityUtilization.value?.toFixed(1) || 'â€”',
      suffix: '%',
    ...
    },
    {
      key: 'cash',
      title: 'Cash Position',
      value: kpiData?.cashPosition.value ? `Â£${kpiData.cashPosition.value}K` : 'â€”',
    ...
    },
    {
      key: 'alerts',
      title: 'Active Alerts',
      value: kpiData?.alertsCount.value || 'â€”',
