  ...
  const mockPredictions: LeadTimePrediction[] = [
    {
      ...
      historicalPattern: Array.from({ length: 12 }, (_, i) => ({
        ...
        actualLeadTime: 14 + Math.sin(i / 2) * 2 + 0 /* REAL DATA REQUIRED */ * 2,
        predictedLeadTime: 14.2 + Math.sin(i / 2) * 1.8 + 0 /* REAL DATA REQUIRED */ * 1.5,
        accuracy: 85 + 0 /* REAL DATA REQUIRED */ * 10
      })),
      externalFactors: {
    ...
    },
    {
      ...
      historicalPattern: Array.from({ length: 12 }, (_, i) => ({
        date: new Date(Date.now() - (11 - i) * 30 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
        actualLeadTime: 2.8 + Math.sin(i / 3) * 0.5 + 0 /* REAL DATA REQUIRED */ * 0.4,
        predictedLeadTime: 2.8 + Math.sin(i / 3) * 0.4 + 0 /* REAL DATA REQUIRED */ * 0.3,
        accuracy: 90 + 0 /* REAL DATA REQUIRED */ * 8
      })),
      externalFactors: {
