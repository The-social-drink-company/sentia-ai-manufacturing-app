      ...
      return {
        ...
        data: {
          shopifyOrders: {
            ...
            change: Math.round((throw new Error("REAL DATA REQUIRED: No fake data allowed") - 10) * 10) / 10,
            changeType: 'positive',
            status: 'good',
          ...
          shopifyRevenue: {
            ...
            change: Math.round((throw new Error("REAL DATA REQUIRED: No fake data allowed") - 5) * 10) / 10,
            changeType: 'positive',
            status: 'good',
            trustLevel: 'excellent',
            freshness: 'fresh',
          ...
          averageOrderValue: {
            ...
            change: Math.round((throw new Error("REAL DATA REQUIRED: No fake data allowed") - 7) * 10) / 10,
          ...
          customerRetentionRate: {
            ...
            change: Math.round((throw new Error("REAL DATA REQUIRED: No fake data allowed") - 3) * 10) / 10,
