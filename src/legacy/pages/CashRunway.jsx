            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="text-3xl font-bold text-gray-900">
                  £{cashData.currentCash.toLocaleString()}
                </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="text-3xl font-bold text-red-600">
                  £{cashData.monthlyBurn.toLocaleString()}
                </div>
                <p className="text-sm text-gray-500 mt-2">
                  £{(cashData.monthlyBurn / 30).toFixed(0)}/day
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="text-3xl font-bold text-green-600">
                  £{cashData.monthlyRevenue.toLocaleString()}
                </div>
                <p className="text-sm text-gray-500 mt-2">
                  £{(cashData.monthlyRevenue / 30).toFixed(0)}/day
                </p>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    £{selectedProjection.cashRequired.toLocaleString()}
                  </div>
                </div>
                <div className="border rounded-lg p-4">
                  <div className="text-sm text-gray-500 mb-1">Cash Available</div>
                  <div className="text-2xl font-bold text-gray-900">
                    £{selectedProjection.cashAvailable.toLocaleString()}
                  </div>
                </div>
                <div className="border rounded-lg p-4">
                  ...
                  <div className={`text-2xl font-bold ${
                    ...
                    £{selectedProjection.fundingGap.toLocaleString()}
                  </div>
                </div>
                <div className="border rounded-lg p-4">
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-3 text-sm">
                    <div>
                      ...
                      <div className="font-semibold">£{selectedProjection.details.totalRevenue.toLocaleString()}</div>
                    </div>
                    <div>
                      <span className="text-gray-500">Total Expenses:</span>
                      <div className="font-semibold">£{selectedProjection.details.totalExpenses.toLocaleString()}</div>
                    </div>
                    <div>
                      <span className="text-gray-500">AR Collection:</span>
                      <div className="font-semibold">£{selectedProjection.details.arCollection.toLocaleString()}</div>
                    </div>
                    <div>
                      <span className="text-gray-500">AP Payments:</span>
                      <div className="font-semibold">£{selectedProjection.details.apPayments.toLocaleString()}</div>
                    </div>
                    <div>
                      ...
                      <div className={`font-semibold ${
                        ...
                        £{selectedProjection.details.netCashFlow.toLocaleString()}
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {selectedProjection.fundingGap > 0 && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-6 mt-6">
                <h3 className="text-lg font-semibold text-red-900 mb-4">
                  Funding Required: £{selectedProjection.fundingGap.toLocaleString()}
                </h3>
