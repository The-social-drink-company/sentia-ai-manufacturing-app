          ...
          {syncResult.success && syncResult.results && (
            <div className="space-y-1">
              <div className="text-xs text-green-700 dark:text-green-300">
                • Invoices synced: {syncResult.results.invoices || 0}
              </div>
              <div className="text-xs text-green-700 dark:text-green-300">
                • Bank transactions synced: {syncResult.results.bankTransactions || 0}
              </div>
              <div className="text-xs text-green-700 dark:text-green-300">
                • Accounts synced: {syncResult.results.accounts || 0}
              </div>
              <div className="text-xs text-green-700 dark:text-green-300">
                • Working capital updated: {syncResult.results.workingCapital ? 'Yes' : 'No'}
              </div>
            </div>
          )}
