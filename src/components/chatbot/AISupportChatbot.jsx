  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      content: '🤖 Hello! I\'m your **Sentia Manufacturing AI Copilot**. I have deep access to your business data and can help you:\n\n📊 **Analyze** your performance metrics and KPIs\n📈 **Explore** inventory levels and forecasting data\n💰 **Review** financial performance and working capital\n🔍 **Investigate** production issues and quality metrics\n💡 **Recommend** optimization strategies\n📋 **Generate** custom reports and insights\n\nWhat would you like to explore today? Ask me about any aspect of your business!',
      timestamp: new Date(),
      enhanced: true
    }
  ]);
  ...
  const sendMessage = async (messageText = inputMessage, isQuickQuestion = false) => {
    ...
    try {
      ...
      const errorMessage = {
        id: Date.now() + 1,
        type: 'bot',
        content: '🚨 I\'m experiencing technical difficulties accessing the AI analysis engine. Please try again in a moment. In the meantime, you can:\n\n• Check your dashboard directly\n• Use the navigation menu to access specific reports\n• Contact support if this issue persists',
        timestamp: new Date(),
        enhanced: true
      };
