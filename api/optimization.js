 ...
 */
router.post(_'/sku/optimize', async _(req, res) => {
  try {
 ...
 */
router.post(_'/batch/optimize', async _(req, res) => {
  try {
 ...
 */
router.post(_'/jobs/create', async _(req, res) => {
  try {
 ...
 */
router.get(_'/jobs/:jobId/status', async _(req, res) => {
  try {
 ...
 */
router.delete(_'/jobs/:jobId', async _(req, res) => {
  try {
    const { jobId } = req.params;
 ...
 */
router.get(_'/queue/status', async _(req, res) => {
  try {
...
if (FEATURE_MULTI_WH) {
   ...
   */
  router.post(_'/multi-warehouse/optimize', async _(req, res) => {
    try {
   ...
   */
  router.post(_'/multi-warehouse/source-selection', async _(req, res) => {
    try {
   ...
   */
  router.post(_'/multi-warehouse/transfers/optimize', async _(req, res) => {
    try {
   ...
   */
  router.get(_'/multi-warehouse/config/:region', async _(req, res) => {
    try {
...
if (FEATURE_WC_OPTIMIZATION) {
   ...
   */
  router.post(_'/working-capital/analyze', async _(req, res) => {
    try {
   ...
   */
  router.post(_'/working-capital/optimize-payments', async _(req, res) => {
    try {
   ...
   */
  router.post(_'/working-capital/apply-constraints', async _(req, res) => {
    try {
      const { orderPlan, region = 'uk' } = req.body;
   ...
   */
  router.get(_'/working-capital/limits/:region', async _(req, res) => {
    try {
      const { region } = req.params;
...
if (FEATURE_CFO_REPORTS) {
   ...
   */
  router.post(_'/reports/board-pack', async _(req, res) => {
    try {
   ...
   */
  router.post(_'/reports/export', async _(req, res) => {
    try {
...
if (FEATURE_DIAGNOSTICS) {
   ...
   */
  router.post(_'/diagnostics/explain', async _(req, res) => {
    try {
   ...
   */
  router.post(_'/diagnostics/report', async _(req, res) => {
    try {
   ...
   */
  router.get(_'/diagnostics/history/:skuId', async _(req, res) => {
    try {
 ...
 * API version info
 */
router.get(_'/version', async _(req, res) => {
  res.json({
 ...
 * Cache management
 */
router.delete(_'/cache', async _(req, res) => {
  try {
 ...
 */
router.post(_'/working-capital/multi-region', async _(req, res) => {
  try {
    const {
      horizonMonths = 12,
 ...
 */
router.get(_'/working-capital/fx-status', async _(req, res) => {
  try {
 ...
 */
router.get(_'/lead-times', async _(req, res) => {
  try {
