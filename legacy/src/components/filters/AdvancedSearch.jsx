                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      {suggestion.type === 'history' && `Search history â€¢ ${formatTimestamp(suggestion.timestamp)}`}
                      {suggestion.type === 'saved' && `Saved search â€¢ ${formatTimestamp(suggestion.timestamp)}`}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400 truncate">
                      {search.query} â€¢ {formatTimestamp(search.timestamp)}
                    </div>
                  </div>
                  {onDeleteSearch && (
                    <button
