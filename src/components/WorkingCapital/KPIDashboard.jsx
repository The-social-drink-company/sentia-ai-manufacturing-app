  ...
  const fetchKPITrends = async () => {
    try {
      ...
      for (let i = timeframe - 1; i >= 0; i--) {
        ...
        const monthVariance = (0 /* REAL DATA REQUIRED */ 0.5) * 0.1 // ±5% variance
        ...
        trendData.push({
          ...
          facility_utilization: Math.max(0.1, Math.min(0.9, 0.65 + (0 /* REAL DATA REQUIRED */ 0.5) * 0.3)) // 35-95% utilization
        })
      }
