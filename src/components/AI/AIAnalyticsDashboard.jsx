...
const ANOMALIES = [
  {
    ...
    detail: 'West region volume +28% vs forecast',
    severity: 'High',
    action: 'Trigger production contingency',
  },
  {
    id: 2,
    title: 'Inventory imbalance',
    detail: 'SKU-521 projected to stock out in 6 days',
    severity: 'Medium',
    action: 'Advance replenishment cycle',
  },
  {
    id: 3,
    title: 'Quality drift',
    detail: 'Fill variance trending +1.2σ above control',
    severity: 'Watch',
...
const AUTOMATIONS = [
  {
    time: '08:45',
    action: 'Optimised production schedule',
    impact: 'Saved 3.2 hrs changeover',
    status: 'Completed',
  },
  {
    time: '10:20',
    action: 'Raised purchase order',
    impact: 'Recovered $185K inventory',
    status: 'Queued',
  },
  {
    time: '11:10',
    action: 'Adjusted pricing tiers',
    impact: '+$24K projected uplift',
    status: 'In progress',
  },
]
    ...
    <section className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Latency, load, and error profile for the orchestrated AI stack.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={forecastChart}>
              ...
              <Tooltip
                formatter={(value, key) =>
                  key === 'confidencePct' ? `${value}%` : `$${value.toLocaleString()}`
                }
              />
              <Area
                type="monotone"
