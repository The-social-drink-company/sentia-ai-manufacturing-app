      ...
      <div className="max-w-2xl w-full px-8">
          ...
          <div className="grid grid-cols-5 gap-3">
            {LOADING_STAGES.map((stage, index) => (
              ...
              >
                ...
                `}>
                  {index < currentStage ? 'âœ“' : stage.id}
                </div>
                <span className={`
        ...
        <div className="mt-6 flex justify-center space-x-6 text-sm">
          <div className="text-gray-400">
            <span className="text-green-400 font-mono">â—</span> Systems Online
          </div>
          <div className="text-gray-400">
            <span className="text-blue-400 font-mono">â—</span> Loading
          </div>
          <div className="text-gray-400">
            <span className="text-gray-600 font-mono">â—</span> Pending
          </div>
        </div>
      </div>
    </div>
