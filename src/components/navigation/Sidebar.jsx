...
const linkClasses = ({ isActive }) =>
  [
    ...
    isActive ? 'border-crystal-border/20 bg-quantum-overlay/80 text-crystal-pure shadow-inner' : 'border-transparent',
  ].join(' ')

export default function Sidebar() {
  return (
    <nav aria-label="Primary" className="flex flex-col gap-4">
      <div className="text-[0.7rem] uppercase tracking-[0.3em] text-crystal-border/60">Sentia Navigation</div>
