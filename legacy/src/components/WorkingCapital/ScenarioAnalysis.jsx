                ...
                <table className="sentia-table">
                  ...
                  <tbody>
                    ...
                    <tr className="sentia-baseline-row">
                      ...
                      <td>Â£{scenarioData.baseline?.scenarios?.baseline?.summary?.netCashFlow?.toLocaleString() || 'N/A'}</td>
                      <td>-</td>
                      <td>Â£{scenarioData.baseline?.scenarios?.baseline?.summary?.minCash?.toLocaleString() || 'N/A'}</td>
                      ...
                      return (
                        <tr key={index}>
                          ...
                          <td className={scenarioCashFlow >= baselineCashFlow ? 'sentia-positive' : 'sentia-negative'}>
                            Â£{scenarioCashFlow.toLocaleString()}
                          </td>
                          <td className={variance.startsWith('+') ? 'sentia-positive' : 'sentia-negative'}>
                            {variance}
                          </td>
                          <td>Â£{scenario.results?.scenarios?.baseline?.summary?.minCash?.toLocaleString() || 'N/A'}</td>
                    ...
                    <div key={index} className={`sentia-alert sentia-alert-${rec.type}`}>
                      <div className="sentia-alert-content">
                        ...
                        <div className="sentia-alert-impact">
                          Impact: Â£{rec.impact?.toLocaleString() || 'N/A'}
                        </div>
                      </div>
                    </div>
                  ))}
