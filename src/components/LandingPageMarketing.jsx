...
const STATS = [
  { label: 'Monthly Revenue', value: '.54M', change: '+12.3%', positive: true },
...
const LandingPageMarketing = ({ onRequestSignIn, onRequestDemo, onRequestContact }) => {
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {STATS.map(stat => (
              ...
              >
                ...
                <div className="mt-1 text-sm">{stat.change} vs last month</div>
              </div>
            ))}
          </div>
        </div>
