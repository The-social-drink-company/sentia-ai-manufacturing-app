...
router.get(_'/status', asyncHandler(async (req, res) => {
  try {
    const status = {
...
router.post(_'/sync', asyncHandler(async (req, res) => {
  try {
...
router.post(_'/sync/inventory', asyncHandler(async (req, res) => {
  try {
...
router.post(_'/sync/sales-orders', asyncHandler(async (req, res) => {
  try {
...
router.post(_'/sync/purchase-orders', asyncHandler(async (req, res) => {
  try {
...
router.post(_'/sync/production-orders', asyncHandler(async (req, res) => {
  try {
...
router.get(_'/inventory', asyncHandler(async (req, res) => {
  try {
...
router.get(_'/stock-movements', asyncHandler(async (req, res) => {
  try {
...
router.get(_'/warehouse-stock', asyncHandler(async (req, res) => {
  try {
...
router.get(_'/bom/:productCode', asyncHandler(async (req, res) => {
  try {
...
router.get(_'/production-orders', asyncHandler(async (req, res) => {
  try {
...
router.get(_'/purchase-orders', asyncHandler(async (req, res) => {
  try {
    const { limit = 50, offset = 0, status } = req.query;
