  ...
  async getAnalytics(options = {}) {
    ...
    try {
      ...
      const combined = {
        ...
        averageOrderValue: (analytics.uk.totalRevenue + analytics.usa.totalRevenue) /
                          (analytics.uk.totalOrders + analytics.usa.totalOrders) || 0,
        conversionRate: ((analytics.uk.totalOrders + analytics.usa.totalOrders) /
                        (analytics.uk.visitors + analytics.usa.visitors)) * 100 || 0
      };
      ...
      orders: [
        {
          ...
          region: 'UK',
          line_items: [
            { title: 'Premium Widget A', quantity: 2, price: '62.50' }
          ]
        },
        {
          id: 5771,
          ...
          region: 'USA',
          line_items: [
            { title: 'Standard Widget B', quantity: 1, price: '89.99' }
          ]
        }
      ],
      analytics: {
