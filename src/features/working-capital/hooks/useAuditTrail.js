...
export const useAuditTrail = componentName => {
  ...
  const logConfigChange = useCallback(
    (setting, oldValue, newValue, reason = '') => {
      return auditService.logSettingsUpdate(setting, oldValue, newValue, {
        component: componentName,
        reason,
        userInitiated: true,
      })
  ...
  const logPerformance = useCallback(
    (metric, value, threshold, context = {}) => {
      return auditService.logPerformanceIssue(metric, value, threshold, {
        component: componentName,
  ...
  const logForecastGeneration = useCallback(
    (forecastType, options = {}) => {
  ...
  const logRecommendationAction = useCallback(
    (recommendationId, action, details = {}) => {
...
export const useDashboardAudit = () => {
  ...
  const logDashboardLoad = useCallback(
    (loadTime, dataPoints) => {
  ...
  const logPeriodChange = useCallback(
    (oldPeriod, newPeriod) => {
  ...
  const logCurrencyChange = useCallback(
  ...
  const logAlertInteraction = useCallback(
    (alertId, action) => {
...
export const useExportAudit = () => {
  ...
  const logExportAttempt = useCallback(
    (format, options = {}) => {
  ...
  const logExportSuccess = useCallback(
  ...
  const logExportFailure = useCallback(
...
export const useForecastAudit = () => {
  ...
  const logForecastRequest = useCallback(
    (forecastType, parameters) => {
  ...
  const logForecastCompletion = useCallback(
    (forecastType, duration, accuracy) => {
  ...
  const logScenarioCreation = useCallback(
