...
const WorkingCapitalModule = () => {
  ...
  const workingCapitalSummary = useMemo(() => {
    ...
    const currentRunway = runwayQuery.data ?? {}

    return {
      liquidityScore: currentOverview.liquidityScore ?? null,
      runwayDays: currentOverview.runwayDays ?? null,
      trend: currentOverview.trends?.weekly ?? currentOverview.trend ?? null,
      runwayMonths: currentRunway.runwayMonths ?? null,
      runwayScenario: currentRunway.scenario ?? 'base'
    }
  }, [overviewQuery.data, runwayQuery.data])
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-10">
        ...
        <section className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/70 p-6 shadow">
            ...
            <p className="mt-2 text-xs text-slate-500">Industry: {benchmarks.industry || 'Manufacturing'}
            </p>
          </div>
        </section>
