...
class WorkingCapitalService {
  constructor() {
    ...
    this.defaults = {
      ...
      facilityLimit: 500000, // Â£500K default credit facility
      minCashBuffer: 50000, // Â£50K minimum cash
    ...
    scenarios.forEach(scenario => {
      ...
      if (scenarioResults.scenarios.baseline.summary.netCashFlow > baselineResults.scenarios.baseline.summary.netCashFlow) {
        recommendations.push({
          ...
          description: `Scenario ${scenario.name} improves net cash flow by Â£${(scenarioResults.scenarios.baseline.summary.netCashFlow - baselineResults.scenarios.baseline.summary.netCashFlow).toFixed(2)}`
        });
      }
