  ...
  return (
    <Card className="sentia-card h-full">
      ...
      <CardContent className="sentia-card-content">
        ...
        <div className="mb-4">
          <h4 className="font-semibold text-gray-800 text-sm mb-2">ðŸ“Š Database Performance</h4>
        ...
        {/* Redis Performance */}
        <div className="mb-4">
          <h4 className="font-semibold text-gray-800 text-sm mb-2">ðŸ”´ Redis Cache</h4>
          <div className="grid grid-cols-2 gap-3">
            <div className="p-2 bg-gray-50 rounded-lg">
              <div className="flex justify-between items-center">
        ...
        {/* Scalability Status */}
        <div className="mb-4">
          <h4 className="font-semibold text-gray-800 text-sm mb-2">âš¡ Auto-Scaling Status</h4>
        ...
        {metrics.database.slowQueries > 0 && (
          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <h4 className="font-semibold text-yellow-800 mb-1">âš ï¸ Performance Alerts</h4>
