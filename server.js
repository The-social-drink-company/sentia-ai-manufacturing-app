...
// import adminRoutes from './routes/adminRoutes.js'; // TEMPORARILY DISABLED FOR CLIENT DELIVERY
...
// app.use('/api/admin', adminRoutes); // TEMPORARILY DISABLED FOR CLIENT DELIVERY
