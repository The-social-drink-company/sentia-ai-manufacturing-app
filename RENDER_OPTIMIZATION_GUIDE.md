...
const Dashboard = createHighPriorityComponent(
  () => import('./pages/Dashboard'),
  'Dashboard'
);

// Route-based - loaded on navigation
const AdminPanel = createRouteComponent(
  'admin-panel',
  () => import('./pages/AdminPanel')
);

// Low priority - loaded when idle
const Settings = createLowPriorityComponent(
...
const FactoryDigitalTwin = lazy(() =>
  import('./components/FactoryDigitalTwin')
);
```
