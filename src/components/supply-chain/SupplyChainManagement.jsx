...
const OverviewTab = ({ data }) => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
      ...
      <div className="mb-4">
        <div className="text-2xl font-bold text-green-600">£{data.performance.costOptimization.totalSavings.toLocaleString()}</div>
      ...
      <div className="space-y-3">
        {data.performance.costOptimization.opportunities.map((opp, index) => (
          <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <span className="text-sm text-green-600">£{opp.potential.toLocaleString()}</span>
          </div>
        ))}
      </div>
    </div>
        ...
        <div key={shipment.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="text-right">
              <div className="font-medium text-gray-900 dark:text-white">£{shipment.value.toLocaleString()}</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
            ...
            <div>
              ...
              <div className="font-medium text-gray-900 dark:text-white">{shipment.origin} → {shipment.destination}</div>
            </div>
            <div>
