...
const ACTIONS = [
  {
    title: 'Accelerate receivables APAC',
    impact: '$640K liquidity',
    owner: 'Regional finance',
    status: 'In progress',
  },
  {
    title: 'Extend supplier terms EMEA',
    impact: '$420K liquidity',
    owner: 'Procurement',
    status: 'Planned',
  },
  {
    title: 'Inventory rebalance Americas',
    impact: '$310K release',
    owner: 'Operations',
    status: 'Active',
  },
  ...
  <section className="space-y-6">
    <header className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Global liquidity, receivables, and payables overview.
        </p>
      </div>
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Rolling 5-month forecast by legal entity region (USD millions).
        </CardDescription>
      </CardHeader>
