        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-amber-700 space-y-1">
            {securityStatus?.failedLoginCount > 0 && (
              <div>• {securityStatus.failedLoginCount} failed login attempt(s) detected</div>
            )}
            ...
            {passwordStatus?.needsChange && !passwordStatus?.isExpired && (
              <div>• Your password expires in {passwordStatus.daysUntilExpiry} days</div>
            )}
            
            {securityStatus?.accountLocked && (
              <div>• Your account is temporarily locked for security</div>
            )}
          </div>
