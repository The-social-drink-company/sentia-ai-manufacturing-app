...
const EnhancedWorkingCapitalAnalysis = () => {
  ...
  const projectionData = useMemo(() => {
    ...
    for (let i = 0; i <= 12; i++) {
      ...
      const variabilityFactor = 1 + (0.5 * parameters.cashFlow.variability) / 100;
    ...
    if (autoRefresh) {
      const interval = setInterval(() => {
        ...
        setParameters(prev => ({
          ...
          cashFlow: {
            ...prev.cashFlow,
            variability: Math.max(5, Math.min(25, prev.cashFlow.variability + 0.5 * 2))
          }
        }));
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  Â£{workingCapitalMetrics.workingCapital.toLocaleString()}
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">
                  Â£{workingCapitalMetrics.freeCashFlow.toLocaleString()}
                </p>
              </div>
              ...
              {scenarios.map((scenario, index) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">
                    Working Capital: Â£{scenario.metrics.workingCapital.toLocaleString()}
                  </p>
                  <p className="text-sm text-gray-600">
