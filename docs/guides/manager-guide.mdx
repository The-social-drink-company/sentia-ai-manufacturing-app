...
Welcome to the CapLiquify Manufacturing Platform! As a **Manager**, you have all Operator capabilities plus the ability to run scenarios, approve optimization plans, and review performance analytics. This guide focuses on strategic decision-making and approval workflows.
