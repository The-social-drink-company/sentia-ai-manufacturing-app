            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">
                  Â£{((workingCapitalData.current || 0) / 1000000).toFixed(2)}M
                </p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900 dark:text-white">
                  Â£{((workingCapitalData.projected || 0) / 1000000).toFixed(2)}M
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                  +Â£{(((workingCapitalData.projected || 0) - (workingCapitalData.current || 0)) / 1000).toFixed(0)}K improvement
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                  Â£{(((workingCapitalData.current || 0) * ((workingCapitalData.optimizationPct || 0) / 100)) / 1000).toFixed(0)}K available
                </p>
              </div>
            </div>
          </div>
