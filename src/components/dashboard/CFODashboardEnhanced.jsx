            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  Real-time Financial Intelligence • {new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                </p>
              </div>
              <button
            ...
            <div className="p-4 bg-gray-50 rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="font-bold">$12M → ${(12 * (1 + growthRate/100)).toFixed(1)}M</p>
                </div>
                <div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              ...
              <ul className="space-y-2 text-sm text-blue-800">
                ...
                <li>• Time Horizon: 180 days</li>
                <li>• Confidence Intervals: 95%, 90%, 80%</li>
                <li>• Variables: Revenue, Expenses, Collections</li>
              </ul>
            </div>
