          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-sm">{workingCapital.dso} → {workingCapital.targetDso} days</span>
              </div>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">DPO Optimization</span>
              <div className="flex items-center space-x-2">
                <span className="text-sm">{workingCapital.dpo} → {workingCapital.targetDpo} days</span>
              </div>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">DIO Optimization</span>
              <div className="flex items-center space-x-2">
                <span className="text-sm">{workingCapital.dio} → {workingCapital.targetDio} days</span>
              </div>
            </div>
