...
const AdminMaintenance = () => {
  ...
  if (!hasPermission('admin.maintenance.database')) {
    return (
      <div className="p-6 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          You don't have permission to access maintenance tools.
        </p>
      </div>
    )
  }
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          System maintenance tools, database operations, and backup management
        </p>
      </div>
      ...
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          Maintenance and system administration interface will be implemented here
        </p>
      </div>
    </div>
  )
