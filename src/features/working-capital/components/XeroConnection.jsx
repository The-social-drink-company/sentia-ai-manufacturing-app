...
export default function XeroConnection({ onConnectionChange }) {
  ...
  const handleDisconnect = () => {
    if (window.confirm('Are you sure you want to disconnect from Xero? This will switch back to sample data.')) {
      disconnect()
    }
  }
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <div className="flex items-center justify-center">
          ...
          <span className="text-gray-700 dark:text-gray-300">
            {isAuthenticating ? 'Connecting to Xero...' : 'Loading connection status...'}
          </span>
        </div>
      </div>
    )
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                {isConnected
                  ? `Connected to ${connectionStatus.tenantName || 'Xero organization'}`
                  : 'Connect to Xero for real financial data'
                }
              </p>
            </div>
          </div>
                ...
                <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono text-xs">
                      {connectionStatus.tenantId?.substring(0, 8) || 'Unknown'}...
                    </span>
                  </div>
                  <div className="flex justify-between">
        ...
        {!isConnected && (
          <div className="mt-6 border-t border-gray-200 dark:border-gray-700 pt-6">
            <h4 className="text-sm font-medium text-gray-900 dark:text-white mb-3">
              Benefits of connecting to Xero:
            </h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                  <CheckCircleIcon className="h-4 w-4 mr-2 text-green-600" />
                  <span>Accurate AR/AP aging</span>
                </div>
                <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                  <CheckCircleIcon className="h-4 w-4 mr-2 text-green-600" />
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className={`text-sm font-medium ${
              ...
              {isConnected ? 'Using Live Data' : 'Using Sample Data'}
            </span>
          </div>
