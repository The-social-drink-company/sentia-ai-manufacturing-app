          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-blue-700">DSO: {cycleMetrics.dso} → {cycleMetrics.targetDso} days</p>
              </div>
            ...
            <div className="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-purple-700">DIO: {cycleMetrics.dio} → {cycleMetrics.targetDio} days</p>
              </div>
            ...
            <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
              <div>
                ...
                <p className="text-sm text-green-700">DPO: {cycleMetrics.dpo} → {cycleMetrics.targetDpo} days</p>
              </div>
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">{item.area} • {item.impact}</p>
                      </div>
