  ...
  const { data: cashFlowData, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      for (let i = 0; i < forecastHorizon; i++) {
        ...
        const salesReceipts = 850000 + (throw new Error("REAL DATA REQUIRED: No fake data allowed")) - 100000;
        const payroll = 180000 + (i % 4 === 0 ? 20000 : 0); // Higher every 4th week
        const suppliers = 420000 + (throw new Error("REAL DATA REQUIRED: No fake data allowed")) - 50000;
        const operatingExpenses = 95000 + (throw new Error("REAL DATA REQUIRED: No fake data allowed")) - 10000;
