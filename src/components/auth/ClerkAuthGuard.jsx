            ...
            <div className="space-y-6">
              <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
                ...
                <CardContent>
                  ...
                  <ul className="space-y-2 text-sm text-gray-300">
                    <li>• 90-day cash unlock projections</li>
                    <li>• Debtor and creditor optimization</li>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
                ...
                <CardContent>
                  ...
                  <ul className="space-y-2 text-sm text-gray-300">
                    <li>• CSV data import & analysis</li>
                    <li>• 12-month cash projections</li>
                    <li>• Risk assessment modeling</li>
                    <li>• Growth scenario planning</li>
                  </ul>
                </CardContent>
              </Card>
