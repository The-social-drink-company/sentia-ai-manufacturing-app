...
const ImportTemplates = () => {
  const templates = [
    {
      name: 'Working Capital Template',
      format: 'XLSX',
      size: '245 KB',
      description: 'Template for importing AR/AP and cash flow data',
    },
    {
      name: 'Inventory Template',
      format: 'CSV',
      size: '128 KB',
      description: 'Template for bulk inventory import',
    },
    {
      name: 'Production Data Template',
      format: 'XLSX',
      size: '312 KB',
      description: 'Template for production metrics and OEE data',
    },
    {
      name: 'Quality Metrics Template',
      format: 'CSV',
      size: '98 KB',
      description: 'Template for quality control data import',
    },
    {
      name: 'Financial Data Template',
      format: 'XLSX',
      size: '456 KB',
      description: 'Template for comprehensive financial data',
    },
  ]
