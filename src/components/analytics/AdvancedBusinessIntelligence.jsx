    ...
    return [
      {
        ...
        description:
          'AI analysis indicates 23% revenue increase potential through optimized pricing strategy in Q4.',
        impact: 'high',
        confidence: 0.89,
        category: 'Revenue',
        actionable: true,
      ...
      },
      {
        ...
        description:
          'Machine learning model predicts excess inventory in Widget A by 15% - recommend production adjustment.',
        impact: 'medium',
        confidence: 0.92,
        category: 'Operations',
        actionable: true,
      ...
      },
      {
        ...
        description:
          'Predictive models show improved cash position expected in next 60 days due to seasonal demand patterns.',
        impact: 'high',
        confidence: 0.87,
        category: 'Finance',
        actionable: false,
      ...
      },
      {
        ...
        description:
          'AI quality analysis identifies process improvements that could reduce defect rate by 0.3%.',
        impact: 'medium',
        confidence: 0.94,
        category: 'Quality',
        actionable: true,
    ...
    return [
      {
        ...
        description:
          'AI recommends shifting 15% of production to off-peak hours to reduce energy costs by $12K monthly.',
        priority: 'high',
      ...
      },
      {
        ...
        description:
          'Redistribute excess Widget A inventory to high-demand regions to improve turnover by 18%.',
        priority: 'medium',
      ...
      },
      {
        ...
        description:
          'Add secondary supplier for Material B to reduce supply chain risk and negotiate 8% cost reduction.',
        priority: 'high',
      ...
      },
      {
        ...
        description:
          'Focus marketing efforts on high-value segment C to increase revenue by $245K with same budget.',
        priority: 'medium',
        impact: '$245K revenue',
        effort: 'medium',
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <span className="font-semibold">
                  {formatCurrency(kpis.financial?.revenue?.value)}
                </span>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <span className="font-semibold">
                  {formatPercentage(kpis.financial?.grossMargin?.value)}
                </span>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <span className="font-semibold">
                  {formatPercentage(kpis.financial?.roi?.value)}
                </span>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <span className="font-semibold">
                  {formatPercentage(kpis.operational?.efficiency?.value)}
                </span>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <span className="font-semibold">
                  {formatPercentage(kpis.operational?.oeeScore?.value)}
                </span>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <span className="font-semibold">
                  {formatPercentage(kpis.operational?.onTimeDelivery?.value)}
                </span>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <span className="font-semibold">
                  {formatPercentage(kpis.customer?.retention?.value)}
                </span>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-2">
                <span className="font-semibold">
                  {formatCurrency(kpis.customer?.lifetimeValue?.value)}
                </span>
              ...
              {insights.map(insight => (
                <div key={insight.id} className="border rounded-lg p-4">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <span
                        className={`px-2 py-1 text-xs rounded-full border ${getImpactColor(insight.impact)}`}
                      >
                        {insight.impact}
                      </span>
              ...
              {recommendations.map(rec => (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span
                      className={`px-2 py-1 text-xs rounded-full border ${getImpactColor(rec.priority)}`}
                    >
                      {rec.priority}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="text-blue-600 text-sm hover:text-blue-800">Implement</button>
                  </div>
                </div>
              ))}
            </div>
