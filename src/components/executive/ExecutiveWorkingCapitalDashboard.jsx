...
const ExecutiveWorkingCapitalDashboard = () => {
  ...
  const boardTalkingPoints = useMemo(() => {
    ...
    return [
      `Potential to unlock £${(optimization.summary.cashUnlockPotential / 1000).toFixed(0)}K in working capital within ${optimization.summary.implementationTimeframe} days`,
      `${fundingRequirements.summary.timeframe} funding requirement of £${(fundingRequirements.summary.totalFundingRequired / 1000).toFixed(0)}K for ${fundingRequirements.summary.growthRate}% growth`,
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Current cash: £{(keyMetrics.currentCash / 1000).toFixed(0)}K
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">£{(keyMetrics.cashUnlockPotential / 1000).toFixed(0)}K</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">£{(keyMetrics.fundingRequired / 1000).toFixed(0)}K</p>
                </div>
                ...
                <div className="space-y-4">
                  {dashboardData?.optimization?.optimizationOpportunities && Object.entries(dashboardData.optimization.optimizationOpportunities).map(([key, opportunity]) => (
                    <div key={key} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-green-600">£{(opportunity.impact / 1000).toFixed(0)}K</p>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <span className="text-xs font-medium text-green-600">
                            £{(action.impact / 1000).toFixed(0)}K impact
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <CardContent className="p-4">
                      <div className="text-center">
                        ...
                        <p className="text-2xl font-bold text-blue-600">
                          £{((dashboardData?.fundingRequirements?.workingCapitalRequirements?.increase || 0) / 1000).toFixed(0)}K
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="p-4">
                      <div className="text-center">
                        ...
                        <p className="text-2xl font-bold text-purple-600">
                          £{((dashboardData?.fundingRequirements?.summary?.totalFundingRequired || 0) / 1000).toFixed(0)}K
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <div key={index} className="p-4 border rounded-lg">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        <div>
                          ...
                          <p className="font-medium">£{(option.amount / 1000).toFixed(0)}K</p>
                        </div>
                        <div>
                ...
                <div className="p-6 bg-gray-50 rounded-lg">
                  ...
                  <div className="prose prose-sm max-w-none text-gray-700">
                    <p>
                      ...
                      £{(keyMetrics.cashUnlockPotential / 1000).toFixed(0)}K in working capital within {keyMetrics.implementationTimeframe} days.
                    </p>
                    <p className="mt-3">
                      For our planned {growthRate[0]}% growth trajectory, we require £{(keyMetrics.fundingRequired / 1000).toFixed(0)}K in additional funding. 
