          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">
                ðŸ¤– Autonomous Testing Dashboard
              </h1>
            ...
            <div className="flex items-center space-x-4">
              <div className={`px-3 py-1 rounded-full text-sm font-medium ${
                ...
                {schedulerStatus?.isRunning ? 'ðŸŸ¢ ACTIVE' : 'ðŸ”´ STOPPED'}
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-6">
            <div className="bg-gray-900 text-green-400 rounded-lg p-4 font-mono text-sm overflow-auto h-96">
              <div className="space-y-1">
                <p>ðŸ¤– AUTONOMOUS TESTING SYSTEM ACTIVE</p>
                <p>â° Running every 10 minutes with self-healing capabilities</p>
                <p>ðŸ” Testing 65 comprehensive test scenarios...</p>
                <p>ðŸ“Š API Endpoints: Detecting connection failures (port 5000)</p>
                <p>ðŸŽ¯ What-If Analysis: Testing client requirements</p>
                <p>ðŸŒ Railway MCP: Health monitoring active</p>
                <p>ðŸ› ï¸ Self-Healing Agents: Triggered on failures</p>
                <p></p>
                <p className="text-yellow-400">âš ï¸  Backend server (port 5000) requires attention</p>
                <p className="text-blue-400">â„¹ï¸  Dashboard available at: /test-monitor</p>
                <p className="text-green-400">âœ“ Frontend server (port 3000) operational</p>
                <p></p>
                <p>ðŸ”„ Next test cycle: {schedulerStatus?.nextRun ? new Date(schedulerStatus.nextRun).toLocaleTimeString() : 'Calculating...'}</p>
              </div>
            </div>
          </div>
        </div>
