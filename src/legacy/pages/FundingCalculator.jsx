            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6 pt-6 border-t">
                <div>
                  ...
                  <div className="text-xl font-bold">£{businessData.currentRevenue.toLocaleString()}</div>
                </div>
                <div>
                  <div className="text-sm text-gray-500">Target Revenue</div>
                  <div className="text-xl font-bold text-green-600">
                    £{fundingNeeds.targetRevenue.toLocaleString()}
                  </div>
                </div>
                <div>
                  <div className="text-sm text-gray-500">Revenue Increase</div>
                  <div className="text-xl font-bold text-blue-600">
                    £{fundingNeeds.revenueIncrease.toLocaleString()}
                  </div>
                </div>
                <div>
                  <div className="text-sm text-gray-500">Total Funding Needed</div>
                  <div className="text-xl font-bold text-red-600">
                    £{fundingNeeds.totalFundingNeeded.toLocaleString()}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="text-2xl font-bold">£{fundingNeeds.workingCapitalNeeds.toLocaleString()}</div>
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="text-2xl font-bold">£{fundingNeeds.expansionCosts.toLocaleString()}</div>
                    <p className="text-xs text-gray-500 mt-1">
                  ...
                  <div className="border rounded-lg p-4">
                    ...
                    <div className="text-2xl font-bold">£{fundingNeeds.cashBufferRequired.toLocaleString()}</div>
                    <p className="text-xs text-gray-500 mt-1">
